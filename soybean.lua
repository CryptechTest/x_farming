...
-- glass of soymilk
core.register_craftitem(":x_farming:glass_soymilk", {
	description = S("Glass of Soymilk") .. '\n' ..
		core.colorize('#DEB887', S('Hunger') .. ': 2'),
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		return core.item_eat(hunger_amount, "vessels:drinking_glass")(itemstack, user, pointed_thing)
	end,
